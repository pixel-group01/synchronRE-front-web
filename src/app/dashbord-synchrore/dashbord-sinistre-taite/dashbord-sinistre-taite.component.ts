...
@Component({
  selector: 'app-dashbord-sinistre-taite',
  templateUrl: './dashbord-sinistre-taite.component.html',
  styleUrls: ['./dashbord-sinistre-taite.component.scss']
})
export class DashbordSinistreTaiteComponent implements OnInit {
